...
<form action="/projects/nReserveInfo" method="POST">
        ...
        <input type="text" id="firstname" name="firstname" value="${cInfo.firstname}" required><br><br>
        
        <label for="lastname">영문 성 (Last Name)<span style="color: red;">*</span></label><br>
        <input type="text" id="lastname" name="lastname" value="${cInfo.lastname}" required><br><br>
